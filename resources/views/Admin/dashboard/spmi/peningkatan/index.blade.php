...
@section('title', 'Peningkatan SPMI')
        ...
        <div class="card-body d-flex justify-content-between align-items-center p-3">
            <div>
                <h5 class="fw-bold mb-1 p-1" style="color: var(--dark-brown);">
                    ...
                    Dokumen Peningkatan SPMI
                </h5>
                <p class="text-muted small mb-0">Daftar dokumen Peningkatan SPMI yang telah diupload</p>
            </div>
            <div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="pe-4">
                                <a href="{{ route('admin.spmi.peningkatan.show', $item->id) }}" 
                                   class="btn btn-sm" 
