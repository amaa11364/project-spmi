        ...
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <a href="{{ route('admin.spmi.pelaksanaan.index') }}" class="btn btn-sm me-3" 
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Informasi lengkap dokumen pelaksanaan SPMI</p>
                    </div>
                </div>
                <div>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="custom-card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.spmi.pelaksanaan.approve', $dokumen->id) }}" method="POST">
                        @csrf
                        <div class="mb-4">
