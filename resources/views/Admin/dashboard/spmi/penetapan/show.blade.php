        ...
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <a href="{{ route('admin.spmi.penetapan.index') }}" class="btn btn-sm me-3" 
...
<div class="custom-card mb-4">
    ...
    <div class="card-body p-4 text-center">
        ...
        <div class="d-grid gap-2">
            {{-- Gunakan route download yang sudah ada --}}
            <a href="{{ route('admin.dokumen.download', $dokumen->id) }}" class="btn" 
            ...
            @if($dokumen->file_extension == 'pdf')
                <a href="{{ route('admin.dokumen.preview', $dokumen->id) }}" target="_blank" class="btn" 
            ...
            <div class="custom-card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.spmi.penetapan.approve', $dokumen->id) }}" method="POST">
                        @csrf
                        <div class="mb-4">
