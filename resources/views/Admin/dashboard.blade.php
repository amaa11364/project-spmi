    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-md-6">
                        <a href="{{ route('admin.settings.iku.index') }}" class="btn btn-outline-success w-100 text-start mb-2">
                            <i class="fas fa-chart-line me-2"></i>Kelola IKU
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ route('admin.settings.unit-kerja.index') }}" class="btn btn-outline-info w-100 text-start mb-2">
