        ...
        <section id="home" class="hero-section"
            @if($heroContent->background_image)
                style="background: linear-gradient(rgba(153, 102, 0, 0.85), rgba(122, 82, 0, 0.85)),
                        url('{{ asset($heroContent->background_image) }}');
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 position-relative text-center text-lg-start hero-content">
                        <h1 class="display-4 fw-bold mb-3 text-white" data-aos="fade-up" data-aos-duration="1000">{{ $heroContent->title }}</h1>
                        <h3 class="h4 mb-4 text-white opacity-90" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">{{ $heroContent->subtitle }}</h3>
                        <div class="lead mb-4 text-white opacity-90 fw-medium" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                            {!! nl2br(e($heroContent->description)) !!}
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 text-center position-relative hero-image">
                        ...
                        @if(auth()->check() && auth()->user()->is_admin)
                            <div class="mt-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <a href="{{ route('admin.hero.edit', $heroContent->id) }}" class="btn btn-sm btn-warning">
