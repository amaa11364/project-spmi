        ...
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <a href="<?php echo e(route('admin.spmi.penetapan.index')); ?>" class="btn btn-sm me-3" 
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Informasi lengkap dokumen penetapan SPMI</p>
                    </div>
                </div>
                <div>
                    ...
                    <?php elseif($dokumen->status == 'approved'): ?>
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="fw-medium mb-0"><?php echo e($dokumen->nama_dokumen); ?></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <span class="badge" style="background: var(--light-brown); color: var(--primary-brown); padding: 6px 12px;">
                                <?php echo e($dokumen->category_label); ?>

                            </span>
                        </div>
                        <div class="col-md-6 mb-3">
                            <small class="text-muted d-block mb-1">Unit Kerja</small>
                            <p class="fw-medium mb-0"><?php echo e($dokumen->unitKerja->nama ?? '-'); ?></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-avatar me-2" style="width: 30px; height: 30px; font-size: 12px; background: var(--primary-brown);">
                                    <?php echo e(strtoupper(substr($dokumen->uploader->name ?? 'U', 0, 1))); ?>

                                </div>
                                <span><?php echo e($dokumen->uploader->name ?? '-'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="fw-medium mb-0">
                                ...
                                <?php echo e($dokumen->created_at->format('d/m/Y H:i')); ?>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="p-3" style="background: #f8f9fa; border-radius: 8px;">
                                <p class="mb-0"><?php echo e($dokumen->deskripsi ?? 'Tidak ada deskripsi'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-avatar me-2" style="width: 30px; height: 30px; font-size: 12px; background: var(--dark-gray);">
                                    <?php echo e(strtoupper(substr($dokumen->approver->name ?? 'A', 0, 1))); ?>

                                </div>
                                <span class="fw-medium"><?php echo e($dokumen->approver->name ?? '-'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="fw-medium mb-0">
                                ...
                                <?php echo e($dokumen->approved_at ? $dokumen->approved_at->format('d/m/Y H:i') : '-'); ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="p-3" style="background: #f8f9fa; border-radius: 8px; border-left: 3px solid <?php echo e($dokumen->status == 'approved' ? '#28a745' : '#dc3545'); ?>;">
                                <p class="mb-0"><?php echo e($dokumen->admin_note); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<div class="custom-card mb-4">
    ...
    <div class="card-body p-4 text-center">
        <div class="mb-4">
            ...
            <p class="mt-3 mb-1 fw-medium"><?php echo e($dokumen->nama_dokumen); ?></p>
            <small class="text-muted">
                <i class="far fa-file me-1"></i> 
                <?php echo e(strtoupper($dokumen->file_extension)); ?> File
            </small>
        </div>

        <div class="d-grid gap-2">
            
            <a href="<?php echo e(route('admin.dokumen.download', $dokumen->id)); ?>" class="btn" 
            ...
            <?php if($dokumen->file_extension == 'pdf'): ?>
                <a href="<?php echo e(route('admin.dokumen.preview', $dokumen->id)); ?>" target="_blank" class="btn" 
            ...
            <div class="custom-card">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('admin.spmi.penetapan.approve', $dokumen->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rahmawati\spmi_try\resources\views/admin/dashboard/spmi/penetapan/show.blade.php ENDPATH**/ ?>