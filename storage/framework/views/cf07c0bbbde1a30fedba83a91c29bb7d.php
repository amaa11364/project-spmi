...
<?php $__env->startSection('title', 'Evaluasi SPMI'); ?>
        ...
        <div class="card-body d-flex justify-content-between align-items-center p-3">
            <div>
                <h5 class="fw-bold mb-1 p-1" style="color: var(--dark-brown);">
                    ...
                    Dokumen Evaluasi SPMI
                </h5>
                <p class="text-muted small mb-0">Daftar dokumen evaluasi SPMI yang telah diupload</p>
            </div>
            <div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="pe-4">
                                <a href="<?php echo e(route('admin.spmi.evaluasi.show', $item->id)); ?>" 
                                   class="btn btn-sm" 
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rahmawati\spmi_try\resources\views/admin/dashboard/spmi/evaluasi/index.blade.php ENDPATH**/ ?>