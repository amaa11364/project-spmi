<?php $__env->startSection('title', 'Pengaturan IKU'); ?>

<?php $__env->startSection('page-icon', 'fa-chart-line'); ?>
        ...
        <div class="card-body d-flex justify-content-between align-items-center p-3">
            ...
            <div class="d-flex gap-2 align-items-center">
                <span class="badge" style="background: var(--light-brown); color: var(--primary-brown); padding: 8px 15px; border-radius: 20px;">
                    <i class="fas fa-list me-1"></i> Total: <?php echo e($ikus->count()); ?> IKU
                </span>
                <a href="<?php echo e(route('admin.settings.iku.create')); ?>" class="btn" style="background: var(--primary-brown); color: white; padding: 8px 18px; border-radius: 8px;">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $ikus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-bottom">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium"><?php echo e($iku->nama); ?></span>
                                </div>
                            </td>
                            <td>
                                <small class="text-muted"><?php echo e(Str::limit($iku->deskripsi, 50) ?: '-'); ?></small>
                            </td>
                            <td>
                                <?php if($iku->status): ?>
                            ...
                            <td class="pe-4">
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('admin.settings.iku.edit', $iku->id)); ?>" 
                                       class="btn btn-sm" 
                                    ...
                                    <button type="button" class="btn btn-sm" 
                                            ...
                                            onclick="confirmDelete('<?php echo e(route('admin.settings.iku.destroy', $iku->id)); ?>', '<?php echo e($iku->nama); ?>')">
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                <div style="opacity: 0.5;">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.iku.create')); ?>" class="btn" style="background: var(--primary-brown); color: white; padding: 8px 20px; border-radius: 8px;">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rahmawati\spmi_try\resources\views/admin/settings/iku-index.blade.php ENDPATH**/ ?>