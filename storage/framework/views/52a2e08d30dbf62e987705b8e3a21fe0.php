...
<?php $__env->startSection('title', 'Detail Dokumen'); ?>
...
<div class="container-fluid px-4 detail-container">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
        ...
        <div class="mt-3 mt-md-0">
            <a href="<?php echo e(route('admin.dokumen.index')); ?>" class="btn btn-outline">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="fw-semibold mb-1" style="color: #1e293b;"><?php echo e($dokumen->nama_dokumen); ?></h5>
                        <div class="d-flex align-items-center gap-3">
                            <span class="badge badge-category" style="background: #f1f5f9; color: #475569;">
                                ...
                                <?php echo e($dokumen->category_label ?? ucfirst($dokumen->category)); ?>

                            </span>
                            <small class="text-muted">
                                <i class="far fa-calendar me-1"></i><?php echo e($dokumen->created_at->format('d F Y')); ?>

                            </small>
                        </div>
                    </div>
                    <?php echo $dokumen->status_badge; ?>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted mb-0"><?php echo e($dokumen->deskripsi); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mb-4 p-3" style="background: #fef9f0; border-radius: 12px; border-left: 4px solid var(--primary);">
                        ...
                        <p class="mb-0" style="color: #5A3A1C;"><?php echo e($dokumen->admin_note); ?></p>
                    </div>
                    <?php endif; ?>

                    <!-- Action Buttons -->
                    <div class="d-flex flex-wrap gap-2">
                        <a href="<?php echo e(route('admin.dokumen.download', $dokumen->id)); ?>" class="btn-action btn-primary">
                            <i class="fas fa-download"></i>
                            Download File
                        </a>
                        
                        <?php if($dokumen->status != 'approved'): ?>
                        <button type="button" class="btn-action btn-success" onclick="updateStatus(<?php echo e($dokumen->id); ?>, 'approved')">
                        ...
                        <button type="button" class="btn-action btn-danger" onclick="updateStatus(<?php echo e($dokumen->id); ?>, 'rejected')">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="user-profile mb-4">
                        <div class="user-avatar-large " style="background: <?php echo e($colors[$colorIndex]); ?>;">
                            <?php echo e($uploader->initials); ?>

                        </div>
                        <div>
                            <h6 class="fw-semibold mb-1" style="color: #1e293b;"><?php echo e($uploader->name); ?></h6>
                            <p class="text-muted small mb-0"><?php echo e($uploader->email); ?></p>
                            <span class="badge bg-<?php echo e($uploader->status_class); ?> mt-2"><?php echo e($uploader->status_label); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="meta-list">
                        <div class="meta-item">
                            ...
                            <span class="meta-value"><?php echo e($dokumen->unitKerja->nama ?? '-'); ?></span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">Total Dokumen</span>
                            <span class="meta-value"><?php echo e($uploader->dokumens()->count()); ?> dokumen</span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">Member Sejak</span>
                            <span class="meta-value"><?php echo e($uploader->created_at->format('d F Y')); ?></span>
                        </div>
                    </div>
                    <?php else: ?>
                ...
                <div class="card-body">
                    <div class="meta-list">
                        <div class="meta-item">
                            ...
                            <span class="meta-value"><?php echo e($dokumen->file_name ?? basename($dokumen->file_path)); ?></span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">Ukuran File</span>
                            <span class="meta-value"><?php echo e($dokumen->file_size_formatted); ?></span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">Tipe File</span>
                            <span class="meta-value"><?php echo e(strtoupper($dokumen->file_extension ?? pathinfo($dokumen->file_path, PATHINFO_EXTENSION))); ?></span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">Kategori</span>
                            <span class="meta-value"><?php echo e($dokumen->category_label ?? ucfirst($dokumen->category)); ?></span>
                        </div>
                        
                        <?php if($dokumen->approved_at): ?>
                        <div class="divider"></div>
                        <div class="meta-item">
                            <span class="meta-label">Disetujui Pada</span>
                            <span class="meta-value"><?php echo e($dokumen->approved_at->format('d F Y H:i')); ?></span>
                        </div>
                        <?php if($dokumen->approver): ?>
                        <div class="meta-item">
                            <span class="meta-label">Disetujui Oleh</span>
                            <span class="meta-value"><?php echo e($dokumen->approver->name); ?></span>
                        </div>
                        <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <div class="meta-item">
                            ...
                            <span class="meta-value"><?php echo e($dokumen->created_at->format('d F Y H:i')); ?></span>
                        </div>
                        <div class="meta-item">
                            <span class="meta-label">Terakhir Diupdate</span>
                            <span class="meta-value"><?php echo e($dokumen->updated_at->format('d F Y H:i')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rahmawati\spmi_try\resources\views/admin/dokumen/show.blade.php ENDPATH**/ ?>