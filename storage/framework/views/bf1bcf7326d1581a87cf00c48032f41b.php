...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Q-TRACK SPMI</title>
...
<body>
        ...
        <main class="main-content-wrapper">
            ...
            <nav class="navbar-custom">
                <div class="navbar-left">
                    ...
                    <h1 class="page-title">
                        <?php if (! empty(trim($__env->yieldContent('page-icon')))): ?>
                            <i class="fas <?php echo $__env->yieldContent('page-icon'); ?>"></i>
                        <?php else: ?>
                ...
                <div class="navbar-right">
                    ...
                    <div class="notification-icon" id="notificationIcon">
                        ...
                        <?php if(isset($unreadNotifications) && $unreadNotifications > 0): ?>
                            <span class="notification-badge"><?php echo e($unreadNotifications); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php
                        ...
                        if ($user && $user->role === 'admin') {
                            $profileRoute = routeExists('profile.edit') ? route('profile.edit') : '#';
                        } else {
                            $profileRoute = routeExists('profile.edit') ? route('profile.edit') : '#';
                        }
                    ?>
                    ...
                    <div class="user-profile" id="userProfileDropdown">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?php echo e($user->name ?? 'User'); ?></span>
                            <span class="user-role"><?php echo e($user->role === 'admin' ? 'Administrator' : 'User'); ?></span>
                        </div>
    ...
    <!-- Hidden Logout Form -->
    <form id="logout-form" action="<?php echo e(routeExists('logout') ? route('logout') : '#'); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('✅ Layout loaded - Admin & User only');
        });
...
</html><?php /**PATH C:\Users\rahmawati\spmi_try\resources\views/layouts/main.blade.php ENDPATH**/ ?>