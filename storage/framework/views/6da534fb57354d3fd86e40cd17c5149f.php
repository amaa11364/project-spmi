...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - APK SPMI</title>
           ...
           <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/')); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="<?php echo e(route('landing.page')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarTentangKami">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('tentang.profil')); ?>">
                                    <i class="fas fa-user-circle me-2"></i>Profil
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('tentang.visi-misi')); ?>">
                                    <i class="fas fa-bullseye me-2"></i>Visi & Misi
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('tentang.sotk')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('upt.index')); ?>">
                                    <i class="fas fa-university me-2"></i>UPT
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('bagian.index')); ?>">
                                    <i class="fas fa-sitemap me-2"></i>Bagian
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('program-studi.index')); ?>">
...
</html><?php /**PATH C:\Users\rahmawati\spmi_try\resources\views/layouts/app.blade.php ENDPATH**/ ?>